...
namespace BaiToan
{
    public partial class Form1 : Form
    {
        ...
        private void btnReset3_Click(object sender, EventArgs e)
        {
            ...
            txtTenFile.Text = "";
            txtViTriGoc.Value = 1;
            txtDoDaiGoc.Value = 3000;
            txtviTriCon.Value = 20;
            txtDoDaiCon.Value = 300;
            dataTable.Clear();
            tabPane1.SelectNextPage();
        }
        ...
        private void txtSoCot2_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    errorProvider1.SetError(txtSoCot2, "Độ dài mỗi đoạn phải là ước số của 2 chuỗi dữ liệu và phải chia hết cho 3");
                    return;
                }
            }
            catch
